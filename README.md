...
- **Notes (KoS)**
  - Optional per-player note icon on the KoS tab
  - Mouseover shows the full note text; click to create/edit/clear
...
- If Spy has no KoS entries, nothing is imported and a chat message is shown
